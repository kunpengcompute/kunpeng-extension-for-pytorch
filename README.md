...
- [2026/04] KPEX项目首次上线，支持AlphaFold2应用计算融合算子优化、KuDNN算子后端对接与KUPL后端对接。
...
- **社区互动**：通过 [【讨论】](https://gitcode.com/kunpengcompute/kunpeng-extension-for-pytorch/discussions)参与交流。
